...
user_1 = User.create!(name: "April", email: "aprileliza@gmail.com", password: "p", address: "160 Randall Street, San Francisco, CA, 94131")
user_2 = User.create!(name: "Laura", email: "laurapalmer.gmail.com", password: "l")
